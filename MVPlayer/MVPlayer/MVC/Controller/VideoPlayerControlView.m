...
- (UIButton *)shrinkScreenButton
{
    if (!_shrinkScreenButton) {
        ...
        [_shrinkScreenButton setImage:[UIImage imageNamed:@"shrinkscreen"] forState:UIControlStateNormal];
...
- (UISlider *)progressSlider
{
    if (!_progressSlider) {
        ...
        [_progressSlider setThumbImage:[UIImage imageNamed:@"point"] forState:UIControlStateNormal];
...
{
    if (name) {
        NSString *path = [NSString stringWithFormat:@"VideoPlayer.bundle/%@",name];
        return path;
    }
    return nil;
}
